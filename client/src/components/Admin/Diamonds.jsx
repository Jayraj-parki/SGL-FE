...
const Diamonds = () => {
  ...
  //   const lastItem = inventoryData.slice(-1)[0];
  //   return inventoryData.map((item, index) => (
  //     <tr key={index}>
  //       <td>{lastItem.name}</td>
  //       <td>{lastItem.weight}</td>
  //       <td>{lastItem.shape}</td>
  //       <td>{lastItem.price}</td>
  //       <td>{lastItem.colour}</td>
  //       <td>{lastItem.value}</td>
  //       <td>{lastItem.dimensions}</td>
  //       <td>{lastItem.transparency}</td>
  //       <td>{lastItem.hardness}</td>
  //       <td>{lastItem.microscopicexamination}</td>
  //       <td>
  //         {lastItem.image ? (
  //           <img
  //             src={`data:image/png;base64,${lastItem.image}`} // Use the image URL directly
  //             alt="item"
  //             style={{
  //               maxWidth: "50px",
  //               maxHeight: "50px",
  ...
  //         <button
  //           className="btn btn-danger btn-sm"
  //           onClick={() => handleDelete(lastItem._id, index)}
  //         >
  //           Delete
  //         </button>
  //       </td>
  ...
  // Use renderLastTableRow instead of renderTableRowslast in your component
