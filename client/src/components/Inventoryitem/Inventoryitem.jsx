...
const Adminhome = () => {
  ...
  return (
    <div><HomeIcon onClick={()=>navigate("/admin/adminhome")} style={{height:"40px",cursor:"pointer",width:"40px",margin:"5% 0% 0% 5%"}}/>
    <div style={{textAlign:"center",height:"100vh"}}>
        ...
        <div>
            <div className='con' style={{height:"30vh",display:"flex",justifyContent:"space-evenly",alignItems:"center",flexWrap:"wrap"}}>
                ...
                <div className='buti' onClick={()=>navigate("/admin/jewellary")} style={{display:'flex',cursor:"pointer",justifyContent:"center",height:"100px",borderStyle:"solid",alignItems:"center",backgroundColor:"#F4821F",borderRadius:"6px",border:"none"}}>
            ...
            <div className='con' style={{height:"30vh",display:"flex",justifyContent:"space-evenly",alignItems:"center",flexWrap:"wrap"}}>
                ...
                <div className='buti' onClick={()=>navigate("/admin/gemsjewelry")} style={{display:'flex',cursor:"pointer",justifyContent:"center",height:"100px",borderStyle:"solid",alignItems:"center",backgroundColor:"#F4821F",borderRadius:"6px",border:"none"}}>
                    <div>
