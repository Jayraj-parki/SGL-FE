                        ...
                        >
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                - Traits: Energetic, adventurous, and competitive. Aries individuals are natural leaders with a passion for taking on challenges.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                - Traits: Nurturing, intuitive, and empathetic. Cancer individuals are deeply connected to their emotions and have a strong sense of loyalty to their loved ones.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                <h1>Aquarius</h1>
                                <p>Element: Air<br/>
                                - Ruling Planet: Uranus and Saturn<br/>
                                - Traits: Innovative, independent, and humanitarian. Aquarians are often ahead of their time, embracing unconventional ideas and social causes.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                - Traits: Ambitious, disciplined, and practical. Capricorns are hardworking individuals who value tradition and strive for success.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                - Traits: Adaptable, curious, and communicative. Geminis are social butterflies with a love for variety and intellectual stimulation.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                - Traits: Confident, charismatic, and generous. Leos love to be in the spotlight and are natural leaders with a warm and sunny personality.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                <p>Element: Earth<br/>
                                        ...
                                        - Traits: Charming, diplomatic, and fair-minded. Libras seek balance and harmony in all aspects of life and are natural peacemakers.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                <h1>Pisces</h1>
                                <p>Element: Water<br/>
                                        - Ruling Planet: Neptune and Jupiter<br/>
                                        - Traits: Compassionate, artistic, and intuitive. Pisceans are dreamers with a deep emotional side, often drawn to artistic and creative pursuits.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                <p>Element: Water<br/>
                                        ...
                                        - Traits: Optimistic, adventurous, and open-minded. Sagittarians love exploration and are always seeking new experiences and knowledge.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                <h1>Taurus</h1>
                                <p>Element: Earth<br/>
                                        - Ruling Planet: Venus<br/>Taurus
                                        - Traits: Patient, reliable, and determined. Taurus individuals value stability and are known for their practical approach to life.</p>
                          ...
                          <div className="set-WH">
                            ...
                            <div>
                                ...
                                <p>Element: Earth<br/>
                                        - Ruling Planet: Mercury<br/>
                                        - Traits: Detail-orientedVirgo, practical, and analytical. Virgos have a keen eye for perfection and are known for their organizational skills.</p>
